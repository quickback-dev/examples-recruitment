...
export default defineConfig({
  schema: "./src/db/audit-schema.ts",
  out: "./quickback/drizzle/audit",
  dialect: "sqlite",
  driver: "d1-http",
  breakpoints: false, // Disable interactive prompts for CI/automation
  dbCredentials: {
    // Security audit database credentials
    // CLOUDFLARE_ACCOUNT_ID - Your Cloudflare account ID
    // CLOUDFLARE_AUDIT_DATABASE_ID - Your security audit D1 database ID
    // CLOUDFLARE_API_TOKEN - Your Cloudflare API token with D1 permissions
    accountId: process.env.CLOUDFLARE_ACCOUNT_ID!,
    databaseId: process.env.CLOUDFLARE_AUDIT_DATABASE_ID!,
