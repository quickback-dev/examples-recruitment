...
export default defineConfig({
  schema: "./src/db/webhooks-schema.ts",
  out: "./quickback/drizzle/webhooks",
  dialect: "sqlite",
  driver: "d1-http",
  breakpoints: false, // Disable interactive prompts for CI/automation
  dbCredentials: {
    // Webhooks database credentials
    // CLOUDFLARE_ACCOUNT_ID - Your Cloudflare account ID
    // CLOUDFLARE_WEBHOOKS_DATABASE_ID - Your webhooks D1 database ID
    // CLOUDFLARE_API_TOKEN - Your Cloudflare API token with D1 permissions
    accountId: process.env.CLOUDFLARE_ACCOUNT_ID!,
    databaseId: process.env.CLOUDFLARE_WEBHOOKS_DATABASE_ID!,
