 ...
 */
// Generated security helpers for interviews
...
/**
 * Firewall conditions for interviews
 * 2 predicates
 */
export function buildFirewallConditions(ctx: AppContext): SQL | undefined {
  return and(eq(interviews.organizationId, ctx.activeOrgId!), isNull(interviews.deletedAt));
}
...
export const GUARDS_CONFIG = {
  createable: new Set<string>(['applicationId', 'scheduledAt', 'durationMin', 'location', 'privateNotes']),
  updatable: new Set<string>(['scheduledAt', 'durationMin', 'location', 'privateNotes']),
  protected: {
    status: new Set<string>(['complete', 'reschedule', 'cancel']),
  } as Record<string, Set<string>>,
  immutable: new Set<string>(['applicationId']),
